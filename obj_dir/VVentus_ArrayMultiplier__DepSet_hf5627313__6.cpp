...
VL_INLINE_OPT void VVentus_ArrayMultiplier___nba_sequent__TOP__GPGPU_top__DOT__SM_wrapper_1__pipe__DOT__mul__DOT__ArrayMultiplier_1__2(VVentus_ArrayMultiplier* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VVentus__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              VVentus_ArrayMultiplier___nba_sequent__TOP__GPGPU_top__DOT__SM_wrapper_1__pipe__DOT__mul__DOT__ArrayMultiplier_1__2\n"); );
    // Body
    vlSelf->__PVT___T_15 = ((~ ((~ (IData)(vlSymsp->TOP__GPGPU_top__DOT__SM_wrapper_1.__PVT__pipe__DOT__mul__DOT__ArrayMultiplier_1_io_out_ready)) 
                                & (IData)(vlSelf->__PVT__REG_1))) 
                            & (IData)(vlSelf->__PVT__REG));
    vlSelf->__PVT__mulDataModule_io_regEnables_0 = 
        ((~ ((~ (IData)(vlSymsp->TOP__GPGPU_top__DOT__SM_wrapper_1.__PVT__pipe__DOT__mul__DOT__ArrayMultiplier_1_io_out_ready)) 
    ...
    vlSelf->__PVT__mulDataModule_io_b = ((0x15U == 
                                          (0x1fU & 
                                           ...
                                           [0U])) ? 
                                         (((QData)((IData)(
                                                           (vlSymsp->TOP__GPGPU_top__DOT__SM_wrapper_1.__PVT__pipe__DOT__valu__DOT__ScalarALU_1_io_in2 
                                                            >> 0x1fU))) 
                                           << 0x20U) 
                                          | (QData)((IData)(vlSymsp->TOP__GPGPU_top__DOT__SM_wrapper_1.__PVT__pipe__DOT__valu__DOT__ScalarALU_1_io_in2)))
                                          : (QData)((IData)(vlSymsp->TOP__GPGPU_top__DOT__SM_wrapper_1.__PVT__pipe__DOT__valu__DOT__ScalarALU_1_io_in2)));
    vlSelf->__PVT__mul_in1 = ((IData)(vlSelf->__PVT___mul_in1_T_4)
                              ...
                              [0U] : vlSymsp->TOP__GPGPU_top__DOT__SM_wrapper_1.__PVT__pipe__DOT__valu__DOT___GEN_11);
...
VL_INLINE_OPT void VVentus_ArrayMultiplier___nba_sequent__TOP__GPGPU_top__DOT__SM_wrapper_1__pipe__DOT__mul__DOT__ArrayMultiplier_2__0(VVentus_ArrayMultiplier* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VVentus__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              VVentus_ArrayMultiplier___nba_sequent__TOP__GPGPU_top__DOT__SM_wrapper_1__pipe__DOT__mul__DOT__ArrayMultiplier_2__0\n"); );
    // Init
    ...
    if (vlSymsp->TOP.reset) {
        ...
        if ((1U & (~ ((~ (IData)(vlSymsp->TOP__GPGPU_top__DOT__SM_wrapper_1.__PVT__pipe__DOT__mul__DOT__ArrayMultiplier_2_io_out_ready)) 
                      & ((IData)(vlSelf->__PVT__REG) 
                         & (IData)(vlSelf->__PVT__REG_1)))))) {
    ...
    if (vlSelf->__PVT__mulDataModule_io_regEnables_0) {
        ...
        vlSelf->__PVT__cVec_1 = ((IData)(vlSelf->__PVT___mul_in1_T_4)
                                  ? vlSymsp->TOP__GPGPU_top__DOT__SM_wrapper_1.__PVT__pipe__DOT__valu__DOT___GEN_22
                                  : vlSymsp->TOP__GPGPU_top__DOT__SM_wrapper_1.__PVT__pipe__DOT__exe_data__DOT__ram_in3_2
                                 [0U]);

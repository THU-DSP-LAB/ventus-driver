...
VL_INLINE_OPT void VVentus_ArrayMultiplier___nba_sequent__TOP__GPGPU_top__DOT__SM_wrapper__pipe__DOT__mul__DOT__ArrayMultiplier__0(VVentus_ArrayMultiplier* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VVentus__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              VVentus_ArrayMultiplier___nba_sequent__TOP__GPGPU_top__DOT__SM_wrapper__pipe__DOT__mul__DOT__ArrayMultiplier__0\n"); );
    // Init
    ...
    if (vlSymsp->TOP.reset) {
        ...
        if ((1U & (~ ((~ (IData)(vlSymsp->TOP__GPGPU_top__DOT__SM_wrapper.__PVT__pipe__DOT__mul__DOT__ArrayMultiplier_io_out_ready)) 
    ...
    if (vlSelf->__PVT__mulDataModule_io_regEnables_0) {
        ...
        vlSelf->__PVT__cVec_1 = ((IData)(vlSelf->__PVT___mul_in1_T_4)
                                  ? vlSymsp->TOP__GPGPU_top__DOT__SM_wrapper.__PVT__pipe__DOT__valu__DOT___GEN_0
